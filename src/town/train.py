...
INPUT_DATA_PATH = PREPROCESSED_DATA_DIR / "town"
OUTPUT_MODEL_PATH = MODELS_DIR / "town_classifier"
...
def entrenar():
    ...
    try:
        ...
        with open(INPUT_DATA_PATH / "id2town.json", 'r', encoding='utf-8') as f:
            id2town = json.load(f)
        num_labels = len(id2town)
    ...
    final_model_path = OUTPUT_MODEL_PATH / "final_model_town"
